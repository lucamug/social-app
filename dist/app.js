...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__firebase_js__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Main_elm__ = __webpack_require__(7);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Main_elm___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__Main_elm__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__registerServiceWorker__ = __webpack_require__(8);





var app = __WEBPACK_IMPORTED_MODULE_2__Main_elm__["Main"].fullscreen({ width: window.innerWidth, height: window.innerHeight });

Object(__WEBPACK_IMPORTED_MODULE_3__registerServiceWorker__["a" /* default */])();

app.ports.newUser.subscribe(function (_ref) {
  var email = _ref.email,
      password = _ref.password;

  __WEBPACK_IMPORTED_MODULE_1__firebase_js__["a" /* auth */].createUserAndRetrieveDataWithEmailAndPassword(email, password).then(function (user) {
    console.log(user);
...
app.ports.login.subscribe(function (_ref2) {
  var email = _ref2.email,
      password = _ref2.password;

  __WEBPACK_IMPORTED_MODULE_1__firebase_js__["a" /* auth */].signInAndRetrieveDataWithEmailAndPassword(email, password).then(function (user) {
...
app.ports.logout.subscribe(function (_) {
  __WEBPACK_IMPORTED_MODULE_1__firebase_js__["a" /* auth */].signOut();
});

__WEBPACK_IMPORTED_MODULE_1__firebase_js__["a" /* auth */].onAuthStateChanged(function (user) {
  if (user) app.ports.loggedIn.send(user.uid);else app.ports.loggedOut.send("");
}, function (error) {});
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js??ref--2-1!../node_modules/postcss-loader/lib/index.js??postcss!./main.css", function() {
			var newContent = require("!!../node_modules/css-loader/index.js??ref--2-1!../node_modules/postcss-loader/lib/index.js??postcss!./main.css");
...
/* unused harmony export msging */
/* unused harmony export storage */
// import * as firebase from 'firebase'
// import 'firebase/firestore'

// initialize firebase
firebase.initializeApp({ apiKey: "AIzaSyDsVG_kHJs_5xUr4oByMftZdnyUZsWPYZw",
...
var _user$project$Data$RetrievingPassword = {ctor: 'RetrievingPassword'};
var _user$project$Data$CreatingAccount = {ctor: 'CreatingAccount'};
var _user$project$Data$LoggingIn = {ctor: 'LoggingIn'};

var _user$project$Misc$materialIcon = F2(
	function (name, color) {
...
var _user$project$Misc$onClickPreventDefault = function (msg) {
	return A3(
...
var _user$project$Route$People = {ctor: 'People'};
var _user$project$Route$Wall = {ctor: 'Wall'};
var _user$project$Route$Events = {ctor: 'Events'};
var _user$project$Route$Conversations = {ctor: 'Conversations'};
var _user$project$Route$route = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(
			_evancz$url_parser$UrlParser$map,
			_user$project$Route$Conversations,
			_evancz$url_parser$UrlParser$s('conversations')),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Route$Events,
				_evancz$url_parser$UrlParser$s('events')),
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Route$Wall,
					_evancz$url_parser$UrlParser$s('wall')),
				_1: {
					ctor: '::',
					_0: A2(
						_evancz$url_parser$UrlParser$map,
						_user$project$Route$People,
						_evancz$url_parser$UrlParser$s('people')),
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Route$getRoute = function (location) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		_user$project$Route$Conversations,
...
var _user$project$Msgs$ToRoute = function (a) {
	return {ctor: 'ToRoute', _0: a};
};
var _user$project$Msgs$LocationChanged = function (a) {
	return {ctor: 'LocationChanged', _0: a};
};
var _user$project$Msgs$CreateProfileRequested = {ctor: 'CreateProfileRequested'};
var _user$project$Msgs$LogOutRequested = {ctor: 'LogOutRequested'};
var _user$project$Msgs$LogOutSuccess = function (a) {
	return {ctor: 'LogOutSuccess', _0: a};
};
var _user$project$Msgs$LogInSuccess = function (a) {
	return {ctor: 'LogInSuccess', _0: a};
};
var _user$project$Msgs$LoginRequested = {ctor: 'LoginRequested'};
var _user$project$Msgs$Resize = function (a) {
	return {ctor: 'Resize', _0: a};
};
var _user$project$Msgs$PasswordEdited = function (a) {
	return {ctor: 'PasswordEdited', _0: a};
};
var _user$project$Msgs$EmailEdited = function (a) {
	return {ctor: 'EmailEdited', _0: a};
};
var _user$project$Msgs$NoOp = {ctor: 'NoOp'};

var _user$project$Styles$Underline = {ctor: 'Underline'};
var _user$project$Styles$Main = {ctor: 'Main'};
var _user$project$Styles$Sidebar = {ctor: 'Sidebar'};
var _user$project$Styles$Button = {ctor: 'Button'};
var _user$project$Styles$Modal = {ctor: 'Modal'};
var _user$project$Styles$Header = {ctor: 'Header'};
var _user$project$Styles$YellowBar = {ctor: 'YellowBar'};
var _user$project$Styles$Avatar = {ctor: 'Avatar'};
var _user$project$Styles$NoStyle = {ctor: 'NoStyle'};
var _user$project$Styles$Pusher = {ctor: 'Pusher'};
...
var _user$project$Styles$stylesheet = _mdgriffith$style_elements$Style$styleSheet(
	{
		...
		_1: {
			...
			_0: A2(
				_mdgriffith$style_elements$Style$style,
				_user$project$Styles$YellowBar,
				{
					ctor: '::',
					_0: _mdgriffith$style_elements$Style_Color$background(_elm_lang$core$Color$yellow),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				...
				_1: {
					...
					_0: A2(
						_mdgriffith$style_elements$Style$style,
						_user$project$Styles$Button,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Style_Color$text(
								A3(_elm_lang$core$Color$rgb, 256, 256, 256)),
							_1: {
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: A2(
										_mdgriffith$style_elements$Style_Shadow$glow,
										A4(_elm_lang$core$Color$rgba, 128, 128, 128, 0.6),
										2),
									_1: {
										ctor: '::',
										_0: _mdgriffith$style_elements$Style_Border$rounded(8),
										_1: {ctor: '[]'}
									}
								}
							}
					...
					_1: {
						...
						_0: A2(
							_mdgriffith$style_elements$Style$style,
							_user$project$Styles$Pusher,
							{
								ctor: '::',
								_0: _mdgriffith$style_elements$Style_Transition$transitions(
									{
										ctor: '::',
										_0: A4(
											_mdgriffith$style_elements$Style_Transition$Transition,
											0,
											130,
											'ease-in',
											{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										_mdgriffith$style_elements$Style$style,
										_user$project$Styles$Underline,
										{ctor: '[]'}),
									_1: {
										ctor: '::',
										_0: A2(
											_mdgriffith$style_elements$Style$style,
											_user$project$Styles$NoStyle,
											{ctor: '[]'}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _mdgriffith$style_elements$Style_Border$rounded(1000),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
...
var _user$project$LoggedOut$viewLoggedOut = function (loginStatus) {
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$Styles$NoStyle,
		{
			ctor: '::',
			_0: _mdgriffith$style_elements$Element_Attributes$class('green lighten-2'),
			_1: {
				ctor: '::',
				_0: _mdgriffith$style_elements$Element_Attributes$height(_mdgriffith$style_elements$Element_Attributes$fill),
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: A2(_mdgriffith$style_elements$Element_Attributes$paddingXY, 50, 10),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			_0: A3(
				...
				_mdgriffith$style_elements$Element$html(
					A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('6 Of Us'),
							_1: {ctor: '[]'}
						}))),
			_1: {
				ctor: '::',
				_0: A3(
					...
					{
						ctor: '::',
						_0: A2(_user$project$Misc$materialIcon, 'mail', 'green'),
						_1: {
							ctor: '::',
							_0: A3(
								_mdgriffith$style_elements$Element_Input$email,
								...
								A4(
									...
									_user$project$Msgs$EmailEdited,
									'',
									_mdgriffith$style_elements$Element_Input$placeholder(
										{
											text: 'Email',
				...
				_1: {
					...
					_0: A3(
						...
						{
							ctor: '::',
							_0: A2(_user$project$Misc$materialIcon, 'lock', 'green'),
							_1: {
								ctor: '::',
								_0: A3(
									_mdgriffith$style_elements$Element_Input$currentPassword,
									_user$project$Styles$NoStyle,
									{
										ctor: '::',
										_0: _mdgriffith$style_elements$Element_Attributes$paddingLeft(10),
									...
									A4(
										_mdgriffith$style_elements$Element_Input$Text,
										_user$project$Msgs$PasswordEdited,
										'',
										_mdgriffith$style_elements$Element_Input$placeholder(
											{
												text: 'Password',
						...
						_0: A3(
							...
							},
							{
								...
								_0: A3(
									...
									{
										ctor: '::',
										_0: _mdgriffith$style_elements$Element_Attributes$class('waves-effect waves-teal btn-flat'),
										_1: {ctor: '[]'}
									},
									_mdgriffith$style_elements$Element$text('Forgot Password?')),
								_1: {ctor: '[]'}
							}),
						_1: {
							ctor: '::',
								...
								{ctor: '[]'},
								{
									...
									_0: A3(
										...
										_user$project$Styles$NoStyle,
										{
											...
											_1: {
												ctor: '::',
												_0: _user$project$Misc$onClickPreventDefault(_user$project$Msgs$LoginRequested),
												_1: {
													ctor: '::',
													_0: _mdgriffith$style_elements$Element_Attributes$class('waves-effect waves-light btn red'),
													_1: {ctor: '[]'}
												}
											}
										},
										_mdgriffith$style_elements$Element$text('Log In')),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
									...
									},
									{
										...
										_0: A3(
											...
											_user$project$Styles$NoStyle,
											{
												...
												_1: {
													ctor: '::',
													_0: _user$project$Misc$onClickPreventDefault(_user$project$Msgs$CreateProfileRequested),
													_1: {
														ctor: '::',
														_0: _mdgriffith$style_elements$Element_Attributes$class('waves-effect waves-light btn'),
														_1: {ctor: '[]'}
													}
												}
											},
											_mdgriffith$style_elements$Element$text('Create free profile')),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: _mdgriffith$style_elements$Element$screen(
										A3(
												...
												_0: _mdgriffith$style_elements$Element_Attributes$inlineStyle(
													{
														...
														_1: {
															...
															_0: {
																ctor: '_Tuple2',
																_0: 'left',
																_1: (!_elm_lang$core$Native_Utils.eq(loginStatus, _user$project$Data$LoggingIn)) ? '0' : '100%'
															},
															_1: {ctor: '[]'}
														}
													}),
											...
											{
												ctor: '::',
												_0: _mdgriffith$style_elements$Element$text('sup'),
												_1: {ctor: '[]'}
											})),
									_1: {ctor: '[]'}
								}
...
var _user$project$Ports$newUser = _elm_lang$core$Native_Platform.outgoingPort(
	'newUser',
	function (v) {
...
var _user$project$Ports$loggedIn = _elm_lang$core$Native_Platform.incomingPort('loggedIn', _elm_lang$core$Json_Decode$string);
var _user$project$Ports$loggedOut = _elm_lang$core$Native_Platform.incomingPort('loggedOut', _elm_lang$core$Json_Decode$string);

var _user$project$Main$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _elm_lang$window$Window$resizes(_user$project$Msgs$Resize),
			_1: {
				ctor: '::',
				_0: _user$project$Ports$loggedIn(_user$project$Msgs$LogInSuccess),
				_1: {
					ctor: '::',
					_0: _user$project$Ports$loggedOut(_user$project$Msgs$LogOutSuccess),
					_1: {ctor: '[]'}
				}
			}
		});
};
var _user$project$Main$viewTabButton = function (_p0) {
	var _p1 = _p0;
	return A3(
		_mdgriffith$style_elements$Element$row,
		_user$project$Styles$NoStyle,
		{
			...
			_1: {
				ctor: '::',
				_0: _user$project$Misc$onClickPreventDefault(_p1._1),
				_1: {
					ctor: '::',
					_0: _mdgriffith$style_elements$Element_Attributes$center,
					_1: {
		...
		{
			ctor: '::',
			_0: A2(_user$project$Misc$materialIcon, _p1._0, 'black'),
			_1: {ctor: '[]'}
		});
};
var _user$project$Main$viewTabUnderline = F2(
	function (index, length) {
		var barWidth = 100 / _elm_lang$core$Basics$toFloat(length);
		return A3(
			_mdgriffith$style_elements$Element$row,
			_user$project$Styles$Underline,
			{
			...
			},
			{
				...
				_0: A3(
					...
					_user$project$Styles$Pusher,
					{
						ctor: '::',
						_0: _mdgriffith$style_elements$Element_Attributes$width(
							_mdgriffith$style_elements$Element_Attributes$percent(
								_elm_lang$core$Basics$toFloat(index) * barWidth)),
						_1: {ctor: '[]'}
					},
				...
				_1: {
					...
					_0: A3(
						...
						_user$project$Styles$YellowBar,
						{
							ctor: '::',
							_0: _mdgriffith$style_elements$Element_Attributes$width(
								_mdgriffith$style_elements$Element_Attributes$percent(barWidth)),
							_1: {ctor: '[]'}
						},
						_mdgriffith$style_elements$Element$empty),
					_1: {ctor: '[]'}
...
var _user$project$Main$viewTab = function (selectedRoute) {
	var listTabs = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: 'question_answer', _1: _user$project$Route$Conversations},
		_1: {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: 'dns', _1: _user$project$Route$Wall},
			_1: {
				ctor: '::',
				_0: {ctor: '_Tuple2', _0: 'search', _1: _user$project$Route$People},
				_1: {
					ctor: '::',
					_0: {ctor: '_Tuple2', _0: 'date_range', _1: _user$project$Route$Events},
					_1: {ctor: '[]'}
				}
			}
		}
	...
	var indexRoute = A2(
		...
		selectedRoute,
		A2(_elm_lang$core$List$map, _elm_lang$core$Tuple$second, listTabs));
	return A2(
		_mdgriffith$style_elements$Element$map,
		_user$project$Msgs$ToRoute,
		A3(
			_mdgriffith$style_elements$Element$column,
			_user$project$Styles$NoStyle,
			{
				ctor: '::',
				_0: _mdgriffith$style_elements$Element_Attributes$width(
					_mdgriffith$style_elements$Element_Attributes$fillPortion(4)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A3(
					...
					A2(_elm_lang$core$List$map, _user$project$Main$viewTabButton, listTabs)),
				_1: {
					ctor: '::',
					_0: A2(
						_user$project$Main$viewTabUnderline,
						A2(_elm_lang$core$Maybe$withDefault, 0, indexRoute),
						_elm_lang$core$List$length(listTabs)),
					_1: {ctor: '[]'}
				}
			}));
};
var _user$project$Main$viewMain = function (model) {
	var val = function () {
		...
		switch (_p2.ctor) {
			case 'Conversations':
				return _mdgriffith$style_elements$Element$text('Conversations');
			case 'Events':
				return A3(
					_mdgriffith$style_elements$Element$el,
					_user$project$Styles$NoStyle,
					...
					_mdgriffith$style_elements$Element$text('Events'));
			case 'Wall':
				return A3(
					_mdgriffith$style_elements$Element$el,
					_user$project$Styles$NoStyle,
					...
					_mdgriffith$style_elements$Element$text('Wall'));
			default:
				return A3(
					_mdgriffith$style_elements$Element$el,
					_user$project$Styles$NoStyle,
					...
					_mdgriffith$style_elements$Element$text('People'));
		}
	}();
	return A3(
		_mdgriffith$style_elements$Element$el,
...
var _user$project$Main$viewLoggedIn = function (model) {
	return A3(
		_mdgriffith$style_elements$Element$column,
		_user$project$Styles$Main,
		{
		...
		},
		{
			...
			_0: A3(
				...
				{
					ctor: '::',
					_0: _user$project$Main$viewTab(model.route),
					_1: {
						ctor: '::',
						_0: A3(
							_mdgriffith$style_elements$Element$row,
							_user$project$Styles$NoStyle,
							{
								...
								_1: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _user$project$Misc$onClickPreventDefault(_user$project$Msgs$LogOutRequested),
											_1: {ctor: '[]'}
										}
									}
								}
							...
							{
								ctor: '::',
								_0: A2(_user$project$Misc$materialIcon, 'settings', 'black'),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Main$view = function (model) {
	return A2(
		...
		function () {
			...
			switch (_p3.ctor) {
				case 'LoggedOut':
					return _user$project$LoggedOut$viewLoggedOut(_p3._0);
				case 'LoggedIn':
					return _user$project$Main$viewLoggedIn(model);
				default:
					return _mdgriffith$style_elements$Element$text('awaiting');
			}
		}());
};
var _user$project$Main$Model = F5(
	function (a, b, c, d, e) {
		return {viewportDims: a, auth: b, route: c, email: d, password: e};
	});
var _user$project$Main$AwaitingAuth = {ctor: 'AwaitingAuth'};
...
var _user$project$Main$init = F2(
	function (flags, location) {
		return {
			...
			_0: {
				viewportDims: flags,
				auth: _user$project$Main$LoggedOut(_user$project$Data$LoggingIn),
				email: '',
				password: '',
				route: _user$project$Route$getRoute(location)
			},
			...
			case 'CreateProfileRequested':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							auth: _user$project$Main$LoggedOut(_user$project$Data$CreatingAccount)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LogInSuccess':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							auth: _user$project$Main$LoggedIn(_p4._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'LoginRequested':
			...
			case 'ToRoute':
				return {
					...
					_1: _elm_lang$navigation$Navigation$modifyUrl(
						_user$project$Route$routeToString(_p4._0))
				};
			default:
				var _p6 = _p4._0;
				var _p5 = A2(_elm_lang$core$Debug$log, 'location changed: ', _p6);
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							route: _user$project$Route$getRoute(_p6)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
...
var _user$project$Main$main = A2(
	...
	_user$project$Msgs$LocationChanged,
